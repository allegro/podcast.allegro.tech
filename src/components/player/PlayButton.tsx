...
export function PlayButton({player, size = 'large'}: PlayButtonProps) {
    return (
        <button
            type="button"
            style={{backgroundColor: '#FF5A00'}}
            className={clsx(
                'group relative flex flex-shrink-0 items-center justify-center rounded-full hover:bg-slate-900 focus:outline-none focus:ring-slate-700',
                {
            ...
            aria-label={player.playing ? 'Pauza' : 'Odtwórz'}
        >
